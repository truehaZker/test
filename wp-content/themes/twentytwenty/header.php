 ...
 */
 ...
 // If Redux Styles Are Checked
 if ((int)$redux_options['apply-styles'] === 1) {
	 $background               = sanitize_hex_color($redux_options['bg-color']);
	 $header_footer_background = sanitize_hex_color($redux_options['bg-color-footer']);
	 $accent                   = sanitize_hex_color($redux_options['accent-color']);
	 $body                     = sanitize_hex_color($redux_options['text-color']);
 }
